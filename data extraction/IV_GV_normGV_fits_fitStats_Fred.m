function [parameterValuesAct,Ichange,stdIchange] = IV_GV_normGV_fits_fitStats_Fred(cellsUndrugged,cellsDrugged)
TotalC=13;
...
%     fpath = 'C:\Users\Alexander\Desktop\NEURONProjects\CompNeuroProject\CompNeuroProject\data extraction\gating variable plots';
    ...
    meantempI(z,1)=nanmean(tempI(11,:));
    stdtempI(z,1)=nanstd(tempI(11,:));
